...
public class Home {
	...
	private Insurance createPlanInsurance(Insurance newInsurance) {
		System.out.print("보험의 이름을 입력하세요 : ");
		String input = scn.next();
		newInsurance.setName(input);
		
		System.out.print("보험의 아이디를 입력하세요 : ");
		input = scn.next();
		newInsurance.setInsuranceId(input);
		...
		if (inputCondition.equals("Y")) {
			for (Insurance insurance : this.insuranceList.getInsuranceList()) {
				if ((insurance.getType() != newInsurance.getType())
						&& (insurance.getDeniedGender() == newInsurance.getDeniedGender())) {
					continue;
				}
			...
			if (isExist) {
				newInsurance.setRateOfAge(
						this.insuranceList.getInsuranceList().get(Integer.parseInt(inputIndex)).getRateOfAge());
				newInsurance.setRateOfGender(
						this.insuranceList.getInsuranceList().get(Integer.parseInt(inputIndex)).getRateOfGender());
				newInsurance.setRateOfJob(
						this.insuranceList.getInsuranceList().get(Integer.parseInt(inputIndex)).getRateOfJob());
